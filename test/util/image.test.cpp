...
TEST(Image, PNGReadNoProfile) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/no_profile.png"));
    EXPECT_EQ(128, image.data[0]);
    EXPECT_EQ(0, image.data[1]);
    EXPECT_EQ(0, image.data[2]);
    EXPECT_EQ(255, image.data[3]);
...
TEST(Image, PNGReadNoProfileAlpha) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/no_profile_alpha.png"));
...
TEST(Image, PNGReadProfile) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/profile.png"));
    EXPECT_EQ(128, image.data[0]);
    EXPECT_EQ(0, image.data[1]);
    EXPECT_EQ(0, image.data[2]);
    EXPECT_EQ(255, image.data[3]);
...
TEST(Image, PNGReadProfileAlpha) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/profile_alpha.png"));
    EXPECT_EQ(64, image.data[0]);
    EXPECT_EQ(0, image.data[1]);
    EXPECT_EQ(0, image.data[2]);
    EXPECT_EQ(128, image.data[3]);
...
TEST(Image, PNGTile) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/tile.png"));
    EXPECT_EQ(256u, image.size.width);
    EXPECT_EQ(256u, image.size.height);
}

TEST(Image, JPEGTile) {
    PremultipliedImage image = decodeImage(*mapbox::base::readFile("test/fixtures/image/tile.jpeg"));
    EXPECT_EQ(256u, image.size.width);
    EXPECT_EQ(256u, image.size.height);
}
