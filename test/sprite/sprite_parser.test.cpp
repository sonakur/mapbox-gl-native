...
auto readImage(const std::string& name) {
    return decodeImage(*mapbox::base::readFile(name));
}
...
TEST(Sprite, SpriteImageCreationInvalid) {
    ...
    const PremultipliedImage image_1x = decodeImage(*mapbox::base::readFile("test/fixtures/annotations/emerald.png"));
...
TEST(Sprite, SpriteImageCreation2x) {
    const PremultipliedImage image_2x = decodeImage(*mapbox::base::readFile("test/fixtures/annotations/emerald@2x.png"));
...
TEST(Sprite, SpriteParsing) {
    const auto image_1x = *mapbox::base::readFile("test/fixtures/annotations/emerald.png");
    const auto json_1x = *mapbox::base::readFile("test/fixtures/annotations/emerald.json");
