...
static void deleteDatabaseFiles() {
    ...
    mapbox::base::deleteFile(filename);
    mapbox::base::deleteFile(filename + "-wal"s);
    mapbox::base::deleteFile(filename + "-journal"s);
}
...
TEST(OfflineDatabase, TEST_REQUIRES_WRITE(Invalid)) {
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::writeFile(filename, "this is an invalid file");
...
TEST(OfflineDatabase, TEST_REQUIRES_WRITE(GetResourceFromOfflineRegion)) {
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::copyFile("test/fixtures/offline_database/satellite_test.db", filename);
...
TEST(OfflineDatabase, TEST_REQUIRES_WRITE(DISABLED_MaximumAmbientCacheSize)) {
    ...
    auto databaseSize = [] {
        return mapbox::base::readFile(filename)->size();
    };
    ...
    size_t initialSize = mapbox::base::readFile(filename)->size();
    ...
    // clear the cache now.
    EXPECT_EQ(initialSize, mapbox::base::readFile(filename)->size());
}
...
TEST(OfflineDatabase, TEST_REQUIRES_WRITE(DeleteRegion)) {
...

    {
        ...
        EXPECT_LE(mapbox::base::readFile(filename)->size(), util::DEFAULT_MAX_CACHE_SIZE);
...
TEST(OfflineDatabase, MigrateFromV2Schema) {
    ...
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::copyFile("test/fixtures/offline_database/v2.db", filename);
...
TEST(OfflineDatabase, MigrateFromV3Schema) {
    ...
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::copyFile("test/fixtures/offline_database/v3.db", filename);
...
TEST(OfflineDatabase, MigrateFromV4Schema) {
    ...
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::copyFile("test/fixtures/offline_database/v4.db", filename);
...
TEST(OfflineDatabase, MigrateFromV5Schema) {
    ...
    FixtureLog log;
    deleteDatabaseFiles();
    mapbox::base::copyFile("test/fixtures/offline_database/v5.db", filename);
...
TEST(OfflineDatabase, DowngradeSchema) {
    ...
    FixtureLog log;
    mapbox::base::deleteFile(filename);
    mapbox::base::copyFile("test/fixtures/offline_database/v999.db", filename);
...
TEST(OfflineDatabase, CorruptDatabaseOnOpen) {
    FixtureLog log;
    mapbox::base::deleteFile(filename);
    mapbox::base::copyFile("test/fixtures/offline_database/corrupt-immediate.db", filename);
...
TEST(OfflineDatabase, CorruptDatabaseOnQuery) {
    FixtureLog log;
    mapbox::base::deleteFile(filename);
    mapbox::base::copyFile("test/fixtures/offline_database/corrupt-delayed.db", filename);
...
TEST(OfflineDatabase, MergeDatabaseWithSingleRegion_New) {
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/sideload_sat.db", filename_sideload);
...
TEST(OfflineDatabase, MergeDatabaseWithSingleRegion_NoUpdate) {
    ...
    mapbox::base::copyFile("test/fixtures/offline_database/satellite_test.db", filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/sideload_sat.db", filename);
...
TEST(OfflineDatabase, MergeDatabaseWithSingleRegion_AmbientTiles) {
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/sideload_ambient.db", filename_sideload);
...
TEST(OfflineDatabase, MergeDatabaseWithMultipleRegions_New) {
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/sideload_sat_multiple.db", filename_sideload);
...
TEST(OfflineDatabase, MergeDatabaseWithSingleRegionTooManyExistingTiles) {
    ...
    deleteDatabaseFiles();
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/sideload_sat_multiple.db", filename);
    mapbox::base::copyFile("test/fixtures/offline_database/satellite_test.db", filename_sideload);
...
TEST(OfflineDatabase, MergeDatabaseWithInvalidPath) {
    ...
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database", filename_sideload);
...
TEST(OfflineDatabase, MergeDatabaseWithInvalidDb) {
    ...
    mapbox::base::deleteFile(filename_sideload);
    mapbox::base::copyFile("test/fixtures/offline_database/corrupt-immediate.db", filename_sideload);
...
TEST(OfflineDatabase, ChangePath) {
    ...
    mapbox::base::deleteFile(newPath);
}
