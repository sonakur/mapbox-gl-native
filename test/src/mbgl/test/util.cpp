...
void checkImage(const std::string& base,
...
#if !TEST_READ_ONLY
    if (getenv("UPDATE")) {
        mapbox::base::writeFile(base + "/expected.png", encodePNG(actual));
        return;
    }
#endif
    ...
    try {
        expected_image = *mapbox::base::readFile(base + "/expected.png");
...
#if !TEST_READ_ONLY
    mapbox::base::writeFile(base + "/actual.png", encodePNG(actual));
#endif
...
#if !TEST_READ_ONLY
    mapbox::base::writeFile(base + "/diff.png", encodePNG(diff));
#endif
}
