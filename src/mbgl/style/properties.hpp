...
public:
    ...
    */
    ...
    public:
        ...
        template <class T>
        static T evaluate(float z, const GeometryTileFeature& feature, const PropertyMap& state,
                          const PossiblyEvaluatedPropertyValue<T>& v, const T& defaultValue) {
            return v.match(
                [&] (const T& t) {
                    return t;
        ...
        template <class P>
        auto evaluate(float z, const GeometryTileFeature& feature, const PropertyMap& state) const {
