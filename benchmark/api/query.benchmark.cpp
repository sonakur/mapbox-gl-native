...
public:
    QueryBenchmark() {
        ...
        map.getStyle().loadJSON(*mapbox::base::readFile("benchmark/fixtures/api/style.json"));
        ...
        map.getStyle().addImage(std::make_unique<style::Image>("test-icon",
            decodeImage(*mapbox::base::readFile("benchmark/fixtures/api/default_marker.png")), 1.0));
